...
<div>
  ...
  <input title="Введите ключевые слова для поиска." placeholder="Поиск" type="text" name="search_block_form" size="15" maxlength="128">
  <button type="submit" class="btn btn-sm btn-default pull-right" ><span class="glyphicon glyphicon-search"></span></button>
